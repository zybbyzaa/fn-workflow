...
module.exports = function (gulp, common) {
    var name = argv.name,
           isMobile = argv.m;
    var srcHtmlPath = isMobile ? common.config.paths.tmp.mhtml : common.config.paths.tmp.html,
           srcCssPath = common.config.paths.tmp.css,
           srcJsPath = common.config.paths.tmp.js;
